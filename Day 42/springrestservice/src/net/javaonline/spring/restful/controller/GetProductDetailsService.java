...
public class GetProductDetailsService {
	...
	public @ResponseBody List<ProductDetails> getProductMethod1() // @RequestParam(value="itemcode", defaultValue="1")
																	// String itemcode
	{
	...
	public ResponseEntity<ProductDetails> addProductMethod(@RequestBody ProductDetails pdetails,
	...
	public ResponseEntity<ProductDetails> updateProductMethod(@RequestBody ProductDetails pdetails) {
		System.out.println("called....");
